...
0.19);">
    <h4>
        ...
        <button class="btn btn-primary me-2" type="button">
            <a class="text-light" style="text-decoration: none;" href="../petugas/petugasCreateBeritaPage.php">Tambah Berita</a>
        </button>
    </h4>
                ...
                if (mysqli_num_rows($query) == 0) {
                    ...
                    while ($data = mysqli_fetch_assoc($query)) {
                        echo '
                            ...
                            <td>
                                <a href="../petugas/petugasShowBeritaPage.php?id=' . $data['id'] . '">
                                    <i style="color: #212529" class="fa fa-eye fa-2x"></i>
                                </a>
                            </td>

                            <td>
                                <a href="../petugas/petugasEditBeritaPage.php?id=' . $data['id'] . '">
                                    <i style="color: #212529" class="fa fa-edit fa-2x"></i>
                                </a>
                            </td>
                            
                            <td>
                                <a href="../process/deleteBeritaProcess_petugas.php?id=' . $data['id'] . '">
