    ...
    if(isset($_GET['id'])){
        ...
        if (mysqli_num_rows($queryCheck) != 0){
            ...
            echo
               ...
               window.location = "../petugas/petugasDash.php"</script>';
            ...
            if($queryDelete){
                ...
                echo
                    '<script>
                    alert("Delete Success"); window.location = "../petugas/petugasDash.php"
                    </script>';
            }else{
                echo
                    '<script>
                    alert("Delete Failed"); window.location = "../petugas/petugasDash.php"
                    </script>';
            }
        }
