...
0.19);">
    <h4>
        ...
        <button class="btn btn-primary me-2" type="button">
            <a class="text-light" style="text-decoration: none;" href="../user/usercreateulasanpage.php">Tambah Buku</a>
        </button>
    </h4>
    ...
    <div class="d-flex">
        <table class="table ">
            ...
            <tbody>
                <?php
                $query = mysqli_query($con, "SELECT * FROM ulasan ") or
                    die(mysqli_error($con));
                if (mysqli_num_rows($query) == 0) {
                    echo '<tr> <td colspan="7"> Tidak ada data ulasan</td> </tr>';
                } else {
                    $no = 1;
                    while ($data = mysqli_fetch_assoc($query)) {
                        echo '
                            ...
                            <td>' . $data['ulasan'] . '</td>
                            <td>
                                <a href="../user/usereditulasanpage.php?id=' . $data['id'] . '">
